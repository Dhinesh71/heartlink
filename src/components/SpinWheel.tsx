    ...
    <div className="flex flex-col items-center gap-8">
      <div className="relative w-64 h-64">
        ...
        >
          ...
          <div className="absolute top-8 left-1/2 -translate-x-1/2 text-white font-bold text-2xl">
            TRUTH
          </div>
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-white font-bold text-2xl">
            DARE
          </div>
        </div>
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[16px] border-l-transparent border-r-[16px] border-r-transparent border-t-[24px] border-t-[#e0b1cb] z-10"></div>
      </div>

      <button
        onClick={handleSpin}
        disabled={spinning || disabled}
        className="px-8 py-4 bg-gradient-to-r from-[#5e548e] to-[#be95c4] text-white font-bold text-xl rounded-full
