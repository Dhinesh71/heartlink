...
export const QuestionCard = ({ type, question, onComplete, playerNickname }: QuestionCardProps) => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div
        className="relative backdrop-blur-md bg-white/10 rounded-3xl p-6 sm:p-8 border border-white/20"
        style={{
          boxShadow: '0 8px 32px rgba(35, 25, 66, 0.3), 0 0 40px rgba(159, 134, 192, 0.2)',
        }}
      >
        <div className="absolute -top-3 sm:-top-4 left-1/2 -translate-x-1/2 px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-[#5e548e] to-[#be95c4] rounded-full">
        ...
        <div className="mt-4 mb-6">
          <p className="text-white/60 text-xs sm:text-sm text-center mb-2">
